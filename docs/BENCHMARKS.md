...
1. **Linux: WSL2 Ubuntu 22.04** (Intel(R) Core(TM) i7-8550U CPU @ 1.80GH)
   ...
   из-за этого они работают медленнее. При этом AVL имеет меньше вращений и переподвешиваний поддеревьев, чем Splay, поэтому работает шустрее.